        ...
        <div className="Container2">
          <div className="FooterBox">
            <div className="FooterTitleBox">
              ...
              <a href="#" className="FooterNumber">
                +(351) 282 405 600
              </a>
              <a href="#" className="FooterNumber2">
                +(351) 282 405 697
              </a>
              <a href="#" className="FooterMail">
                info@autodromodoalgarve.com
              </a>
              <h1 className="FooterTitle3">БИЛЕТЫ</h1>
              <a href="#" className="FooterNumber3">
                +(351) 282 405 600
              </a>
              <a href="#" className="FooterPage">
                tickets@autodromodoalgarve.com
              </a>
            ...
            <div className="FooterImframeBox">
              <h1 className="FooterIframeTitle">АДРЕС</h1>
